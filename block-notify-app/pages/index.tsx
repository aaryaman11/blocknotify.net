...
export default async function Home() {
  const web3auth = new Web3Auth({
    clientId: process.env.Web3AuthClientID!, // get it from Web3Auth Dashboard
    web3AuthNetwork: "cyan",
    chainConfig: {
      chainNamespace: "eip155",
      chainId: "Ox5",
      rpcTarget: "https://rpc.ankr.com/eth_goerli", //tenderily rpc to put
  ...
  return (
    <>
      <Head>
        <title>Block Notify</title>
        <meta name="description" content="Your Web3 Security Guard" />
